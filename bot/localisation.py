...
class Localisation:
    ...
    DOWNLOAD_START = "Downloading sir ... 📥 \n"
    
    UPLOAD_START = "📤 Uploading here ... 📤 \n"
    
    COMPRESS_START = "Me Trying hard to compress"
    
    RCHD_BOT_API_LIMIT = "size greater than maximum allowed size (50MB). Neverthless, trying to upload."
    
    RCHD_TG_API_LIMIT = "Successfully Downloaded in {} seconds.\nDetected File Size: {}\nSorry. But, I cannot upload files greater than 1.95GB due to Telegram API limitations."
    
    COMPRESS_SUCCESS = "Successfully Downloaded in {}\n\n📀 Compressed in {}\n\n📤 Uploaded in {}\n\nBy @featzai"
